...
public class MyLinkedListPublicTester {
	...
	private void integerLinkedList(){
		MyLinkedList<Integer>.Node node0 = this.integerList.new Node(this.intData[0]);
		MyLinkedList<Integer>.Node node1 = this.integerList.new Node(this.intData[1]);
		MyLinkedList<Integer>.Node node2 = this.integerList.new Node(this.intData[2]);
		MyLinkedList<Integer>.Node node3 = this.integerList.new Node(this.intData[3]);
		MyLinkedList<Integer>.Node node4 = this.integerList.new Node(this.intData[4]);

		this.integerList.head.next = node0;
			node0.prev = this.integerList.head;
			node0.next = node1;
			node1.prev = node0;
			node1.next = node2;
			node2.prev = node1;
			...
			node3.next = node4;
			node4.prev = node3; 
			node4.next = this.integerList.tail;
			this.integerList.tail.prev = node4;
			this.integerList.size = 5;
	}
	...
	public void testReverseMethod(){
		...
		assertEquals("check previous index 0", Integer.valueOf(5), this.integerList.tail.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(4), this.integerList.tail.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(3), this.integerList.tail.prev.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(2), this.integerList.tail.prev.prev.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(1), this.integerList.tail.prev.prev.prev.prev.prev.data); 

		this.integerList.reverseRegion(1, 3);
		assertEquals("check index 0", Integer.valueOf(1), this.integerList.head.next.data);
		assertEquals("check index 1", Integer.valueOf(4), this.integerList.head.next.next.data);
		assertEquals("check index 2", Integer.valueOf(3), this.integerList.head.next.next.next.data);
		assertEquals("check index 3", Integer.valueOf(2), this.integerList.head.next.next.next.next.data);
		assertEquals("check index 4", Integer.valueOf(5), this.integerList.head.next.next.next.next.next.data);

		assertEquals("check index 1", this.integerList.head.next.next, this.integerList.getNth(1));


		assertEquals("check previous index 0", Integer.valueOf(5), this.integerList.tail.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(2), this.integerList.tail.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(3), this.integerList.tail.prev.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(4), this.integerList.tail.prev.prev.prev.prev.data); 
		assertEquals("check previous index 0", Integer.valueOf(1), this.integerList.tail.prev.prev.prev.prev.prev.data); 

		assertEquals("check previous index 0", null, this.integerList.tail.data); 
	...
	@Test
	public void testReverseEvery(){
		populateLinkedList();
		this.threeStringList.reverseRegion(1, 2);
		assertEquals("check index 0", "Paul Cao", this.threeStringList.head.next.next.next.data);
		assertEquals("check index 1", "Christine Alvarado", this.threeStringList.head.next.next.data);
		assertEquals("check index 2", "CSE 12", this.threeStringList.head.next.data);

		assertEquals("check index 2 using previous", "Paul Cao", this.threeStringList.tail.prev.data); 
		assertEquals("check index 1 using previous", "Christine Alvarado", this.threeStringList.tail.prev.prev.data); 
		assertEquals("check index 0 using previous", "CSE 12", this.threeStringList.tail.prev.prev.prev.data); 
